...
return $.vegas;}};function resize($img,settings){var options={align:"center",valign:"top"};$.extend(options,settings);if($img.height()===0){$img.load(function(){resize($(this),settings);});return;}
